...
#| fig-width: 12
#| fig-height: 3
plot_mono_marginal_by_group(fit_nf, df_model, covs = mono_covs[which(!str_detect(mono_covs, "food"))], dodge = 0.4)
```
...
#| fig-width: 12
#| fig-height: 3
plot_mono_marginal_by_group(fit, df_model, covs = mono_covs, dodge = 0.4)
```
