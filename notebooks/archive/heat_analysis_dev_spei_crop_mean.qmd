...
# Var settings
clim_var <- "dev_value_spei_crop_mean_12m"
covars_fem <- c(
  "country",
  "cluster",
  "adm1_name",
...
#| fig-width: 7
#| fig-height: 3
plot_continuous_marginal(df_marg_cont_fem_all_viol, covar_label = "Climate factor", lims = c(0.02, 0.35))
...
#| fig-width: 7
#| fig-height: 3
plot_continuous_marginal(df_marg_cont_fem_np_viol, covar_label = "Climate factor", lims = c(0.005, 0.38))
