...
df_clim_viol_summ <- (
  ...
  %>% summarise(
    ...
    parent = mean(live_with_parent, na.rm = TRUE),
...
#| fig-width: 12
#| fig-height: 2.5
p <- plot_single_continuous_marginal_by_group(fit_nonranef, df_model, cov = "clim")
(
  p
  + scale_y_continuous(
    limits = c(0, 0.4),
...
#| fig-width: 12
#| fig-height: 2.5
p <- plot_single_continuous_marginal_by_group(fit_ns, df_model, cov = "clim")
(
  p
  + scale_y_continuous(
    limits = c(0, 0.4),
...
#         + clim
#         + (1 + clim | country)
#         + gp(lon, lat, cov = 'matern32', gr = TRUE)
#       )"
#     )
#   )
# )
...
#| fig-width: 12
#| fig-height: 2.5
p <- plot_single_continuous_marginal_by_group(fit, df_model, cov = "clim")
(
  p
  + scale_y_continuous(
    limits = c(0, 0.4),
