---
title: "Model main UTCI effect on all sexual violence - children"
format: html
editor: visual
---
...
#| fig-width: 5
#| fig-height: 3
plot_baseline_levels(fit_ns, lims = c(0, 0.2))
```
...
#| fig-width: 5
#| fig-height: 3
plot_baseline_levels(fit, lims = c(0, 0.2))
```
