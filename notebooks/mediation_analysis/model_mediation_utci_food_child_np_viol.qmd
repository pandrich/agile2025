...
#| fig-width: 5
#| fig-height: 2.5
plot_mono_marginal(fit_nf, df_model, covs = mono_covs[which(!str_detect(mono_covs, "food"))])
ggsave(
  path = fig_dir,
...
#| fig-width: 6
#| fig-height: 2.5
plot_mono_marginal_by_group(fit_nf, df_model, covs = mono_covs[which(!str_detect(mono_covs, "food"))], dodge = 0.6)
```
...
#| fig-width: 5
#| fig-height: 2.5
plot_mono_marginal(fit_test_fi_nf, df_model_fi, covs = mono_covs[which(!str_detect(mono_covs, "food"))])
# ggsave(
#   path = fig_dir,
#   filename = paste0("marginal_prob_mono_", clim_label, "_", pop_label, "_", viol_label, ".png")
# )
...
#| fig-width: 6
#| fig-height: 2.5
plot_mono_marginal_by_group(fit_test_fi_nf, df_model_fi, covs = mono_covs[which(!str_detect(mono_covs, "food"))], dodge = 0.4)
```
...
#| fig-width: 5
#| fig-height: 2.5
plot_mono_marginal(fit_test_fi, df_model_fi, covs = mono_covs[which(!str_detect(mono_covs, "food"))])
# ggsave(
#   path = fig_dir,
#   filename = paste0("marginal_prob_mono_", clim_label, "_", pop_label, "_", viol_label, ".png")
# )
...
#| fig-width: 6
#| fig-height: 2.5
plot_mono_marginal_by_group(fit_test_fi, df_model_fi, covs = mono_covs[which(!str_detect(mono_covs, "food"))], dodge = 0.4)
```
