...
seed <- 4179232 #8098332 #sum(sapply(str_split(nb_name, pattern = "", simplify = TRUE), FUN = utf8ToInt))
...
ggsave(
  path = fig_dir,
  filename = "clim_post_no_sp_sim_single_country.png"
)
```
...
ggsave(
  path = fig_dir,
  filename = "clim_post_conf_sim_single_country.png"
)
```
...
ggsave(
  path = fig_dir,
  filename = "clim_post_ind_sp_sim_single_country.png"
)
```
