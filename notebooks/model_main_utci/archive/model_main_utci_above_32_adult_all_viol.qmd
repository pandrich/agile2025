...
#| fig-height: 3.2
(
  plot_mono_marginal_by_group(fit_nonranef, df_model, covs = c("rel_age_ord", "school_level"), dodge = 0.6)
  + theme(
    legend.position = "top"
  )
)
ggsave(
  path = fig_dir,
  filename = paste0("marginal_prob_mono_main_effect_by_country_", clim_label, "_", pop_label, "_", viol_label, "_nonranef.png")
)
```
...
#| fig-width: 5
#| fig-height: 3
plot_baseline_levels(fit, lims = c(0, 0.55))
```
