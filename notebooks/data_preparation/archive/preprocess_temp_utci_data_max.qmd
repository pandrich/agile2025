...
df_temp <- (
  read_csv(
    file.path(proc_data_dir, "climate/temp_2m", "temp_max_daily_all_countries_max.csv"),
...
```{r}
df_all_temp_12m %>% write_csv(file.path(proc_data_dir, "processed_temp_daily_max.csv"))
