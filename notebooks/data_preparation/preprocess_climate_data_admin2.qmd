...
proc_data_dir <- root("data/processed/climate")
out_data_dir <- file.path(proc_data_dir, "combined")
dir.create(out_data_dir, showWarnings = FALSE)
...
df_utci <- (
  read_csv(
    file.path(proc_data_dir, "utci", "utci_max_daily_all_countries_admin2.csv"),
...
df_utci_pop_weighted <- (
  read_csv(
    file.path(proc_data_dir, "utci", "weighted_utci_max_daily_all_countries_admin2.csv"),
    show_col_types = FALSE
  )
)
```
...
df_utci_girl_weighted <- (
  read_csv(
    file.path(
      proc_data_dir,
      "utci",
      "age_weighted_utci_max_daily_all_countries_admin2.csv"
    ),
    show_col_types = FALSE
  )
)
...
df_temp <- (
  read_csv(
    file.path(proc_data_dir, "temp_2m", "temp_max_daily_all_countries_admin2.csv"),
    show_col_types = FALSE
  )
)
```
...
df_temp_pop_weighted <- (
  read_csv(
    file.path(proc_data_dir, "temp_2m", "weighted_temp_max_daily_all_countries_admin2.csv"),
    show_col_types = FALSE
  )
)
```
...
df_spei <- (
  read_csv(
    file.path(
      proc_data_dir,
      "spei",
      "spei_monthly_all_countries_admin2.csv"
    ),
    show_col_types = FALSE
  )
)
...
df_spei_pop_weighted <- (
  read_csv(
    file.path(
      proc_data_dir,
      "spei",
      "weighted_spei_monthly_all_countries_admin2.csv"
    ),
    show_col_types = FALSE
  )
)
...
(
  ggplot(
    data = df_clim_12m %>% filter(date > "2015-01-01"), 
    aes(
      x = value_pop_weighted_utci_max_above_32_12m, 
      fill = country
    )
  )
  + geom_histogram(
...
(
  ggplot(
    data = df_clim_12m %>% filter(date > "2015-01-01"), 
    aes(
      x = dev_value_pop_weighted_utci_max_above_32_12m, 
      fill = country
    )
  )
  + geom_histogram(
...
(
  ggplot(
    data = df_clim_12m %>% filter(date > "2015-01-01"), 
    aes(
      x = value_pop_weighted_utci_max_above_1sd_12m, 
      fill = country
    )
  )
  + geom_histogram(
...
(
  ggplot(
    data = df_clim_12m %>% filter(date > "2015-01-01"), 
    aes(
      x = dev_value_pop_weighted_utci_max_above_1sd_12m, 
      fill = country
    )
  )
  + geom_histogram(
...
(
  ...
  %>% select(
    date,
    adm_name,
    value_pop_weighted_utci_max_above_32_12m,
  )
  %>% ggplot(
    mapping = aes(x = date, y = value_pop_weighted_utci_max_above_32_12m)
  )
  + geom_line(
    color = "#0292b7",
    linewidth = 1.3
...
(
  ...
  %>% select(
    date,
    adm_name,
    dev_value_pop_weighted_utci_max_above_32_12m,
  )
  %>% ggplot(
    mapping = aes(x = date, y = dev_value_pop_weighted_utci_max_above_32_12m)
  )
  + geom_line(
    color = "#dc7726",
    linewidth = 1.3
...
(
  ggplot(
    data = df_clim_12m %>% filter(date > "2015-01-01"), 
    aes(
      x = value_pop_weighted_temp_2m_max_above_32_12m, 
      fill = country
    )
  )
  + geom_histogram(
...
(
  ggplot(
    data = df_clim_12m %>% filter(date > "2015-01-01"), 
    aes(
      x = dev_value_pop_weighted_temp_2m_max_above_32_12m, 
      fill = country
    )
  )
  + geom_histogram(
...
(
  ggplot(
    data = df_clim_12m %>% filter(date > "2015-01-01"), 
    aes(
      x = value_pop_weighted_temp_2m_max_above_1sd_12m, 
      fill = country
    )
  )
  + geom_histogram(
...
(
  ggplot(
    data = df_clim_12m %>% filter(date > "2015-01-01"), 
    aes(
      x = dev_value_pop_weighted_temp_2m_max_above_1sd_12m, 
      fill = country
    )
  )
  + geom_histogram(
...
(
  ...
  %>% select(
    date,
    adm_name,
    value_pop_weighted_temp_2m_max_above_1sd_12m,
  )
  %>% ggplot(
    mapping = aes(x = date, y = value_pop_weighted_temp_2m_max_above_1sd_12m)
  )
  + geom_line(
    color = "#0292b7",
    linewidth = 1.3
...
(
  ...
  %>% select(
    date,
    adm_name,
    dev_value_pop_weighted_temp_2m_max_above_1sd_12m,
  )
  %>% ggplot(
    mapping = aes(x = date, y = dev_value_pop_weighted_temp_2m_max_above_1sd_12m)
  )
  + geom_line(
    color = "#dc7726",
    linewidth = 1.3
...
```{r}
df_clim_12m %>% write_csv(file.path(out_data_dir, "processed_utci_temp_spei_daily_admin2.csv"))
```
