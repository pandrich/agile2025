...
# Var settings
clim_var <- "value_girl_weighted_spei_below_1sd_12m"
clim_label <- "spei"
viol_var <- "sv_np"
viol_label <- "np_viol"
pop_label <- "child"
...
#| fig-width: 5
#| fig-height: 3
plot_baseline_levels(fit_nf, lims = c(0, 0.15))
```
...
#| fig-width: 8.5
#| fig-height: 3
plot_mono_marginal(fit_nf, df_model, covs = c("rel_age_ord"))
ggsave(
  path = fig_dir,
...
#| fig-height: 3
(
  plot_mono_marginal_by_group(fit_nf, df_model, covs = c("rel_age_ord", "food_price_above_1s_12m"), dodge = 0.6)
  # + theme(
  #   legend.position = "top"
  # )
...
#| fig-width: 7
#| fig-height: 3
plot_mono_marginal_by_group(fit_nf, df_model, covs = c("clim"), dodge = 0.8)
ggsave(
  path = fig_dir,
  filename = paste0("marginal_prob_clim_by_country_mono_", clim_label, "_", pop_label, "_", viol_label, "_nf.png")
)
```


```{r}
# conditional_effects(fit_nf, effects = c("rel_age_ord", "clim"), group = "country")
```
...
#| fig-width: 5
#| fig-height: 3
plot_baseline_levels(fit, lims = c(0, 0.18))
```
...
#| fig-height: 3
(
  plot_mono_marginal_by_group(fit, df_model, covs = c("rel_age_ord", "food_price_above_1s_12m"), dodge = 0.8)
  # + theme(
  #   legend.position = "top"
  # )
  + ggh4x::force_panelsizes(
...
#| fig-width: 5
#| fig-height: 3
plot_baseline_levels(fit_test_fi_nf, lims = c(0, 0.15))
```
...
#| fig-width: 13
#| fig-height: 3
plot_bin_marginal_by_group(fit_test_fi_nf, df_model_fi, covs = c(bin_covs, "clim_stress"), group = "country")
# ggsave(
#   path = fig_dir,
#   filename = paste0("marginal_prob_bin_", clim_label, "_", pop_label, "_", viol_label, "_nf.png")
# )
...
#| fig-width: 5
#| fig-height: 3
plot_mono_marginal(fit_test_fi_nf, df_model_fi, covs = c("rel_age_ord"))
# ggsave(
#   path = fig_dir,
#   filename = paste0("marginal_prob_mono_", clim_label, "_", pop_label, "_", viol_label, ".png")
# )
...
#| fig-width: 6
#| fig-height: 2.5
plot_mono_marginal_by_group(fit_test_fi_nf, df_model_fi, covs = c("rel_age_ord"), dodge = 0.6)
```
...
#| fig-width: 5
#| fig-height: 3.5
plot_bin_marginal(fit_test_fi, df_model_fi, covs = c(bin_covs, "food_stress", "clim_stress"), lims = c(-0.13, 0.21))
ggsave(
  path = fig_dir,
  filename = paste0("marginal_prob_bin_", clim_label, "_", pop_label, "_", viol_label, ".png")
)
...
#| fig-width: 13
#| fig-height: 3
plot_bin_marginal_by_group(fit_test_fi, df_model_fi, covs = c(bin_covs, "food_stress", "clim_stress"), group = "country")
# ggsave(
#   path = fig_dir,
#   filename = paste0("marginal_prob_bin_", clim_label, "_", pop_label, "_", viol_label, "_nf.png")
# )
...
#| fig-width: 6
#| fig-height: 2.5
plot_mono_marginal(fit_test_fi, df_model_fi, covs = c("rel_age_ord"))
# ggsave(
#   path = fig_dir,
#   filename = paste0("marginal_prob_mono_", clim_label, "_", pop_label, "_", viol_label, ".png")
# )
...
#| fig-width: 6
#| fig-height: 2.5
plot_mono_marginal_by_group(fit_test_fi, df_model_fi, covs = c("rel_age_ord"), dodge = 0.4)
```
...
```{r}
plot_mono_marginal_by_group(fit_nf, df_model, covs = c("clim"), dodge = 0.4)
```
